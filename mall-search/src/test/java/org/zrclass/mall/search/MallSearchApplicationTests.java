package org.zrclass.mall.search;
...
import org.zrclass.mall.search.bean.Account;
import org.zrclass.mall.search.bean.User;
...
//		}
	...
	public void indexTest() throws IOException {
		...
		request.id("2");
		// 第1种方式
//		request.source("userName","zrclass","age","20","gender","男");

		// 第2种方式
		User user = new User();
		user.setUserName("zrclass");
		user.setAge("20");
		user.setGender("男");
